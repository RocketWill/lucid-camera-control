...
class PreviewWidget(QGroupBox):
    ...
    def __init__(self) -> None:
        ...
        preview_actions.addWidget(self.start_button)
        preview_actions.addWidget(self.stop_button)
        preview_actions.addStretch(1)
        preview_settings = QHBoxLayout()
        preview_settings.addWidget(self.fps_label)
        preview_settings.addStretch(1)
        preview_settings.addWidget(QLabel("Preview-only contrast"))
        preview_settings.addWidget(self.contrast)

        layout = QVBoxLayout(self)
        layout.addLayout(preview_actions)
        layout.addLayout(preview_settings)
